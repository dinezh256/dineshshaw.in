...
export const GlobalContextProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const syncSystemMinimalMode = () => {
            setSystemMinimalMode(mediaQuery.matches ? "minimal-dark" : "minimal-light");
        };
    ...
    return (
        <GlobalContext.Provider value={{ isLoading, setIsLoading, viewMode, viewModePreference, setViewMode, enterMinimalMode, cycleViewMode, isMinimal }}>
            {children}
