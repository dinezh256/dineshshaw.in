...
import { ChevronsDown, ChevronsUp, Circle } from "react-feather";
      ...
      <div className="about-section">
        <div className="about-section-inner">
          ...
          <div className="about-me">
            <AnimateText
              text={t("about.sectionTitleAbout").toUpperCase()}
              animate={false}
            />
        ...
        <div className="timeline-section">
          <AnimateText
            text={t("about.sectionTitleExperience").toUpperCase()}
            animate={false}
          />
              ...
              >
                {yearwise.map(({ id, start, end, position }) => (
                  <div className="org-level" key={id}>
                    <CheckMarkIcon />{" "}
                    <h4>{`${formatTimelineDate(start, locale, t)} - ${formatTimelineDate(end, locale, t)}`}</h4>
                    <h4>—&nbsp;&nbsp;{position}</h4>
                  </div>
                ))}
              </div>
